...
class SourcesParser(FileParser):
    ...
    def __init__(self, fname, msgs,repos):
        super().__init__(fname)
        self.msgs = msgs
        self.repos = repos

    # TODO: resolve repo id
    def model(self, r):
        return Source(r['title'], self.msgs.get_note(r['text_id']), self.msgs.get_note(r['info_id']), self.repos.get(r['repo_id']))
